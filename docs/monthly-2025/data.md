...
const data2 = ref([
    ...
    },
    {
        ...
        cost: 247,
        divideTo: [],
        additionToMe: Math.floor(247/3),
        owner: 1,
    },
]);

// S C
const data3Other = [67, 33];
const data3 = ref([
    {
        name: 'Nhà tháng 2',
        cost: 6500,
    ...
    {
        name: 'Nước sh tháng 2',
        cost: 99,
        divideTo: [],
        additionToMe: Math.floor(99/3),
        owner: 1,
    },
    {
